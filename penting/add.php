...
if (file_exists($upload_path)) {
    ...
    if (mysqli_query($con, $sql_data)) {
        echo "<script>alert('Data berhasil ditambahkan!'); window.location.href = 'data_tambah.php';</script>";
    } else {
        echo "<script>alert('Data gagal ditambahkan!'); window.location.href = 'data_tambah.php';</script>";
    }
}
