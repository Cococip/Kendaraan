                                ...
                                <div class="card-body">
                                    <div class="panel-heading">
                                        <form class="form-inline">
                                            <div class="form-group" style="float:right;">
                                                <a class="btn btn-primary" href="dataa_tambah.php"><span class="mdi mdi-library-plus"></span> Tambah</a>
                                            </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-hover table-striped">
                                            ...
                                            <tbody>
                                                <?php
                                                $query = "SELECT * FROM data WHERE id_mas = '$id_mas' AND (
                                                    id_data LIKE '%$q%' OR
                                                    id_mas LIKE '%$q%' OR
                                                    uraian LIKE '%$q%' OR
                                                ...
                                                if ($result && $result->num_rows > 0) {
                                                    ...
                                                    while ($row = $result->fetch_object()) {
                                                        ...
                                                        echo "<td>{$row->file}</td>";
                                                        echo "<td class='nw'>
                                                                <a class='btn btn-xs btn-warning' href='ubaha.php?id_data={$row->id_data}'>Ubah</a> ||
                                                                <a class='btn btn-xs btn-danger' href='aksi.php?act=dataa_hapus&ID={$row->id_data}' onclick='return confirm(\"Hapus data?\")'><span class='mdi mdi-delete'></span></a>
                                                            </td>";
                                                        echo "</tr>";
